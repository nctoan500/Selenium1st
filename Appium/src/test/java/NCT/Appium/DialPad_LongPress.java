...
public class DialPad_LongPress {
	...
	public void setUp() throws Exception {
		...
		capabilities.setCapability("appPackage", "com.asus.asusincallui");
		capabilities.setCapability("appActivity", "com.asus.asusincallui.InCallActivity");
